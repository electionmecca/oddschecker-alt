...
#html = scraperwiki.scrape('http://www.oddschecker.com/horse-racing-betting/catterick')
import urllib
html = urllib.urlopen("http://www.oddschecker.com/horse-racing-betting/catterick").read()
#print html
